...
from secret_sharing import secret_int_to_points, points_to_secret_int, \
    ...
    BitcoinToZB32SecretSharer, Base64ToBase64SecretSharer
...
class ShamirSharingTest(unittest.TestCase):
    ...
    def test_b64_to_b64_sharing(self):
        self.split_and_recover_secret(Base64ToBase64SecretSharer, 3, 5, "aGVsbG8gISEhIHNlY3JldCBzaGFyZSEhIQ")
